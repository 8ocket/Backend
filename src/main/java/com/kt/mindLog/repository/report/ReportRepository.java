...
public interface ReportRepository extends JpaRepository<Report, UUID> {
	boolean existsByUserIdAndStatusAndReportTypeAndSessionCountAndPeriodStartAndPeriodEnd(UUID userId, ReportStatus status,
		ReportType reportType, int sessionCount, LocalDate periodStart, LocalDate periodEnd);
